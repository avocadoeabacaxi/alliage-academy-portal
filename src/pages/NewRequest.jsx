...
export default function NewRequest() {
  ...
  const steps = [
    ...
    { title: t('form.step6.title'), desc: t('form.step6.desc') },
    { title: t('form.step7.title'), desc: t('form.step7.desc') },
  ...
  const canProceed = () => {
    switch (step) {
      ...
      case 5: return form.justification.length > 10;
      case 6: return form.priority && form.deadline_requested;
      default: return true;
    }
  };
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // 2. Translate multilingual fields
